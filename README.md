...
CSMP - это библиотека для работы с методом Compressive Sensing (CS) для сжатия и восстановления 1D сигналов. Название CSMP расшифровывается как **C**ompressive **S**ensing with **M**atching **P**ursuit.
